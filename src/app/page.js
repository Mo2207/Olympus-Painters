        ...
        >
          <div>
            ...
            <ul className="list-none text-left max-w-xl mx-auto text-lg space-y-6">
              <li className="border border-gray-300 rounded-lg p-6 transition-transform duration-300 hover:shadow-lg hover:scale-[1.02] bg-white">
...
>
  <div className="bg-gray-100 shadow-lg rounded-xl p-8 max-w-lg w-full space-y-6">
    ...
    <div className="flex justify-center space-x-4 pt-4">
      {/* Facebook Icon */}
      <a
        href="https://www.facebook.com/profile.php?id=61577736417490" // Replace with actual page
        target="_blank"
